...
<!--			<a class="btn btn-warning" href="<?php echo U('Member/member_list');?>" role="button" title="会员列表"><i class="ace-icon fa fa-users"></i></a>-->
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <form class="form-horizontal ajaxForm2 productform" name="product_list_add" method="post" action="<?php echo U('product_runadd');?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="product_list_name" id="product_list_name" placeholder="输入产品名称" class="col-xs-10 col-sm-4" required/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="product_list_price" id="product_list_price" placeholder="输入产品价格" class="col-xs-10 col-sm-4" required/>
                            <span class="lbl">&nbsp;&nbsp;<span class="red">*</span>必填</span>
                        </div>
                    </div>
                    <div class="space-4"></div>
