		...
		<div class="nav-wrap">
            ...
            <div class="page-content">
                    ...
                    <div id="user-profile-1" class="user-profile row">
                        <div class="col-xs-12 col-sm-3 center">
                            ...
                            <div class="clearfix">
                                ...
                                <div class="grid2">
                                    <a href="<?php echo U('News/news_list',array('keytype'=>'news_auto','key'=>$admin['admin_id']));?>">
                                        <span class="bigger-175 blue"><?php echo ($admin['news_count']); ?></span>
                                    </a>
                                    <br />
                                    文章数												</div>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-9">
                            ...
                            <div class="widget-box transparent">
                                <div class="widget-header widget-header-small">
                                    <h4 class="widget-title blue profile-info-name">
                ...
                <div class="modal fade in" id="myModaledit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <form class="form-horizontal ajaxForm2" name="admin_runedit" method="post" action="<?php echo U('admin_runedit');?>">
