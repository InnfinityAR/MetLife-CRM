            ...
            <div class="col-xs-12">
                <form class="form-horizontal memberform" name="member_list_edit" method="post" action="<?php echo U('member_runedit');?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="member_list_name" id="member_list_username" value="<?php echo ($member_list_edit["member_list_name"]); ?>" placeholder="输入客户姓名" class="col-xs-10 col-sm-4" required/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="member_list_birth" value="<?php echo (date($member_list_edit,'Y-m-d')); ?>"  class="col-xs-10 col-sm-4" />
                            <span class="lbl">&nbsp;&nbsp;<span class="red">*</span>只能填写数字</span>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea  name="member_list_remark" cols="20" rows="4" class="col-xs-10 col-sm-4 limited"   id="form-field-12"  maxlength="125"><?php echo ($member_list_edit["member_list_remark"]); ?></textarea>
