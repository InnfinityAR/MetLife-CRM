...
<!--			<a class="btn btn-warning" href="<?php echo U('Member/member_list');?>" role="button" title="会员列表"><i class="ace-icon fa fa-users"></i></a>-->
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <form class="form-horizontal productform ajaxForm2" name="product_list_edit" method="post" action="<?php echo U('product_runedit');?>">
                    <input type="hidden" name="product_list_id" id="product_list_id" value="<?php echo ($product_list_edit["product_list_id"]); ?>" />
                    
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 产品名称：  </label>
                        <div class="col-sm-10">
                            <input type="text" name="product_list_name" id="product_list_username" value="<?php echo ($product_list_edit["product_list_name"]); ?>" placeholder="输入客户姓名" class="col-xs-10 col-sm-4" required/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="product_list_price" id="product_list_price" value="<?php echo ($product_list_edit["product_list_price"]); ?>"  placeholder="输入产品价格" class="col-xs-10 col-sm-4" required/>
                            <span class="lbl">&nbsp;&nbsp;<span class="red">*</span>必填</span>
                        </div>
                    </div>
                    <div class="space-4"></div>
...
<!-- 此页相关插件js -->
    ...
    <script>
        $(function () {
            ...
            $("input[name='product_list_birth']").datetimepicker({
                step: 10,
                format: "Y-m-d",
                timepicker: false,
                todayButton: true,
