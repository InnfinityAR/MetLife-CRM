...
class SitPlanController extends AuthController {
    /*
     * 用户管理
     */
...
//        $this->assign("status", $status);
    ...
    public function pdf() {
        ...
        if($arrdateone&&$arrdatetwo){
            $html = "<h2 style='text-align:center'>".$arrdateone."至".$arrdatetwo."SITPLAN表</h2>";
            $pdf_name = $arrdateone."至".$arrdatetwo."SITPLAN表";
        }else{
            $html = "<h2 style='text-align:center'>ISTPLAN表</h2>";
            $pdf_name = "SITPLAN表";
        }
    ...
    public function runadd() {
        if (!IS_AJAX) {
            ...
            if ($res !== false) {
                ...
                $this->success('客户添加成功', U('index'), 1);
            } else {
                $this->error('客户添加失败', U('index'), 0);
            }
        }
    }
...
//            }
    ...
    public function del() {
        ...
        if ($rst !== false) {
            $this->success('客户删除成功', U('index', array('p' => $p)), 1);
        } else {
            $this->error('客户删除失败', U('index', array('p' => $p)), 0);
        }
    }
